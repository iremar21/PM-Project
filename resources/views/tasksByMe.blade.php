        ...
        <div class="p-1.5 min-w-full inline-block align-middle">
          <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="flex justify-center px-6 py-4 space-x-4">
              <a href="{{route('dashboard')}}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">Mis tareas en curso</a>
              <a href="{{route('dashboard.plansByMe')}}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">Planes creados por mí</a>
              <a href="{{route('dashboard.plansManagedByMe')}}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">Planes dirigidos por mí</a>
            </div>
            <!-- End Navigation Links -->

            <!-- Search Bar -->
            <div class="mb-2 mt-2 min-w-full">
              <form class="max-w-md mx-auto" method="GET" action="{{route('dashboard.searchTasksByMe')}}">   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="search" name="search" value="{{ isset($search) ? $search : ''}}" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Buscar por título, descripción o plan..." required />
